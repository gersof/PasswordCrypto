...
namespace PasswordCrypto
{
    ...
    {
        private string keyCrypto;
        public CryptoUtilities()
        {
            keyCrypto = System.Configuration.ConfigurationManager.AppSettings["claveCrypto"] as string;
        }
        public string Encriptar(string texto)
        {
            ...
            //hashing
            keyArray = hashmd5.ComputeHash(UTF8Encoding.UTF8.GetBytes(keyCrypto));
